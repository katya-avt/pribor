...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $specificationItem = $this->route('specificationItem');
        $extraRules = [];
        ...
        $drawingRules = array_merge([
            'required',
            new UniqueRuleForSpecificationItemTable('specification_item', 'specification_number', $specification->number, $specificationItem->id),
