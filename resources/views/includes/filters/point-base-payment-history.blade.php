<form
    action="{{ route('periodic-requisites.labor-payment.show', ['point' => $point->code]) }}"
    method="get">
    ...
    <div class="d-flex mb-3">
        ...
        <x-forms.buttons.filter-clean route="periodic-requisites.labor-payment.show"
                                      :params="['point' => $point->code]"></x-forms.buttons.filter-clean>
    </div>
</form>
