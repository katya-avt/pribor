<form id="itemFilterForm"
      action="{{ route('admin.marked-for-deletion.items.index') }}"
      method="get">
    ...
    <div class="d-flex mb-3">
        ...
        <x-forms.buttons.filter-clean route="admin.marked-for-deletion.items.index"></x-forms.buttons.filter-clean>
    </div>
</form>
