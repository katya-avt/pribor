...
namespace Tests\Feature\Requests\Orders\ShippedOrderStatistics;
...
class IndexRequestTest extends TestCase
{
    ...
    {
        $from = $this->from("/shipped-order-statistics");

        $response = $from->get(route('shipped-order-statistics.index', $mockedRequestData));
