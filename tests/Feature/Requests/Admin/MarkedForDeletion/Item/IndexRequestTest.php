...
namespace Tests\Feature\Requests\Admin\MarkedForDeletion\Item;
...
class IndexRequestTest extends TestCase
{
    ...
    {
        $from = $this->from('/admin/marked-for-deletion/items');

        $response = $from->get(route('admin.marked-for-deletion.items.index', $mockedRequestData));
